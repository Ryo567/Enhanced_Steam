...
localization_promise = (function (){
    ...
    localized_strings = {
        ...
        "el":       {},
        "es":       {
        empty_wishlist: "Lista de deseados vacía",
		...
		language: "Idioma",
		highlight: "Destacar",
		options_owned: "Artículos que tienes",
		options_wishlist: "Artículos en tu lista de deseados",
		options_coupon: "Artículos con cupones",
		options_gift: "Artículos almacenados como regalo",
		options_guest: "Artículos para los que tienes pase de invitado",
		options_friends_wishlist: "Artículos en la lista de deseados de tus amigos",
		options_hide_install: "Ocultar el botón \"Instalar Steam\" en la cabecera",
		options_drm: "Mostrar advertencias DRM de terceros",
		options_lowestprice: "Mostrar historial de información de precios",
		options_metacritic: "Mostrar puntuaciones metacríticas de los usuarios",
		options_steamdb: "Mostrar enlaces a SteamDB",
		options_wsgf: "Mostrar información WSGF (panorámica)",
		options_carousel_description: "Mostrar descripciones de aplicación en la tienda",
		options_profile_links: "Mostrar enlaces del perfil a",
		options_total_spent: "Mostrar \"Gastos totales\" en la página de la cuenta",
		options_group_events: "Mostrar vista general de eventos de grupos",
		options_greenlight_banner: "Reemplazar cabecera de Steam Greenlight",
		options_es_bg: "Establecer fondo personalizado en la la pantalla de editar perfil",
		options_library: "Mostrar botón Biblioteca en la cabecera (BETA)",
		options_hide_about: "Ocultar enlace Acerca de en la cabecera",
		options_about_text: "Acerca de <a href='http://www.enhancedsteam.com' style='color:#8bc53f;'>Enhanced Steam</a>:<p>Enhanced Steam es una extension para Google Chrome que añade algunas mejoras a la página web de Steam.<p>Mejoras incluidas:<ul><li>Se destacan los juegos que tienes</li><li>Se destacan los juegos de tu lista de deseados</li><li>Calcula los descuentos en packs basándose en los juegos que tienes</li><li>Te muestra el dinero que te has gastado en Steam desde el inicio de la cuenta</li><li>Se destacan los contenidos descargables que tienes</li><li>Se han arreglado los iconos de juegos  \"Sin imagen disponible\" en la lista de deseados</li><li>Se advierte de los títulos con DRM de terceros</li></ul><p>Si esta extensión te parece útil, puedes realizar donaciones.",
		tag: "Etiqueta",
        ...
        coupon_application_note: "Los cupones de tu inventario se aplicarán automáticamente al realizar una compra.",
        coupon_learn_more: "<a href=\"https://support.steampowered.com/kb_article.php?ref=4210-YIPC-0275\">Más información</a> acerca de los cupones de Steam",
        add_to_cart: "Añadir al carrito",
        drm_third_party: "Advertencia: este título utiliza DRM de terceros",
        empty_cart: "Carrito vacío",
        events_view_all: "VER TODO",
        events: "Eventos",
        dlc_data_header: "Detalles de contenido descargable",
        tag_owned: "En propiedad",
        tag_wishlist: "Deseado",
        tag_coupon: "Cupón",
        tag_inv_gift: "Regalo",
        tag_inv_guestpass: "Pase de invitado",
        tag_friends_want: "<a href=\"http://steamcommunity.com/my/friendsthatplay/__appid__\">__friendcount__ desea</a>",
		inventory_market_text: "Mostrar precio de mercado en el inventario (¡en pruebas!)",
		credits: "Créditos",
		stores: "Tiendas",
		region: "Región",
		all: "Todas",
		...
		custom_background_help: "Todos los usuarios de Enhanced Steam verán este fondo en tu perfil. Quienes no sean usuarios de Enhanced Steam verán el fondo de perfil que tengas puesto.",
		total_size: "Tam. máximo"
    },
        "fi":       {},
        "fr":       {
